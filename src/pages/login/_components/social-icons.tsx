...
export function MicrosoftIcon() {
  return (
    <svg
      ...
      height="16"
    >
      <rect x="0" y="0" width="208" height="208" fill="rgba(0,0,0,0.3)" />
      <rect x="240" y="0" width="208" height="208" fill="rgba(0,0,0,0.2)" />
      <rect x="0" y="240" width="208" height="208" fill="rgba(0,0,0,0.2)" />
      <rect x="240" y="240" width="208" height="208" fill="rgba(0,0,0,0.3)" />
    </svg>
  );
}
